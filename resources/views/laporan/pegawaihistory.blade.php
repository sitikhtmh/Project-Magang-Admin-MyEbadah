...
<div>
  <table class="table">
    ...
    <tbody>
    @foreach($pegawaihistory as $peghis)
        <tr>
          <td>{{$peghis->Nama_Materi}}</td>
          <td>{{$peghis->Mulai_Tes_Awal}}</td>
          <td>{{$peghis->Selesai_Tes_Awal}}</td>
          <td>{{$peghis->Mulai_Tes_Akhir}}</td>
          <td>{{$peghis->Selesai_Tes_Akhir}}</td>
          <td>{{$peghis->Score_Tes_Awal}}</td>
          <td>{{$peghis->Score_Tes_Akhir}}</td>
          <td>
            <a href="/pegawaidetail/{{$peghis->Student_Id}}/{{$peghis->Materi_Id}}" class="btn btn-success btn-sm">Detail</a>
          </td>
        </tr>
      @endforeach
    </tbody>           
