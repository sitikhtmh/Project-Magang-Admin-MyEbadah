            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="/tesawal/store" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        @foreach($tesawal as $tes)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <a href="#" method="post" class="btn btn-warning btn-sm">Edit</a> -->
                                    <a href="#" method="POST" class="btn btn-warning btn-sm" 
                                        data-toggle="modal" 
                                        data-target="#editModal" 
                                        data-id="{{$tes->Quiz_Id}}"
                                        data-materi="{{$tes->Nama_Materi}}"
                                        data-kode="{{$tes->Kode_Quiz}}" 
                                        data-nama="{{$tes->Nama_Quiz}}">
                                        Edit
                                    </a>
                            ...
                            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="/tesawal/delete/{{$tes->Quiz_Id}}" id="#Group_Id_Delete" enctype="multipart/form-data">
                                            {{csrf_field()}}
                            ...
                            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        <form method="POST" action="/tesawal/update" id="#formEditGroup" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Kode_Quiz_Edit" placeholder="Masukkan Kode Materi" name="Kode_Quiz_Edit">
                                            </div>
                                            <div class="form-group">
                                                <label for="Nama_Quiz_Edit">Nama Quiz</label>
                                                <input type="text" class="form-control" id="Nama_Quiz_Edit" placeholder="Masukkan Nama Quiz" name="Nama_Quiz_Edit">
                                            </div>                              
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Batal</button>
